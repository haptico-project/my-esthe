			...
			<footer class="mt-40 pb-6 border-t border-gray-200">
				<div class="w-full px-5 py-6 text-sm text-gray-600 text-center">
					...
					<div class="flex justify-center gap-6 mb-6 text-gray-500">
						<a href="https://www.instagram.com/facetherapie" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="hover:text-gray-900 transition-colors">
						...
						<a href="https://www.tiktok.com/@tftkabonj6g" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="hover:text-gray-900 transition-colors">
